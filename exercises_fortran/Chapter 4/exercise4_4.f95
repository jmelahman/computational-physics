PROGRAM EXERCISE4_4
!   USES GAUSS-LEGENDRE QUADRATURE WITH N=5 TO EVALUATE THE
!   INTEGRAL OF SQRT(1-X**2) FROM -1 TO 1
IMPLICIT NONE
    REAL, PARAMETER :: PI = 4.*ATAN(1.)
    REAL :: FUNC                    !FUNCTIONS BEING SOLVED
    REAL, DIMENSION(16)  :: YI,UI    !ABSCISSAS AND WEIGHTS
    REAL, DIMENSION(64)  :: XI,WI    !ABSCISSAS AND WEIGHTS
    REAL, DIMENSION(5)  :: ZI,VI    !ABSCISSAS AND WEIGHTS
    REAL :: SUM
    INTEGER :: I                    !COUNTER
!
    PRINT *,'EXACT VALUE IS     ',PI/2.
    CALL FILL64(XI,WI)
    CALL FILL16(YI,UI)
    CALL FILL5(ZI,VI)
    SUM = 0
    DO I=1,64
        SUM = SUM+FUNC(XI(I))*WI(I)
    END DO
    PRINT *,'64 ABSCISSAS YIELDS',SUM,'ERROR',SUM-PI/2.
    SUM = 0
    DO I=1,16
        SUM = SUM+FUNC(YI(I))*UI(I)
    END DO
    PRINT *,'16 ABSCISSAS YIELDS',SUM,'ERROR',SUM-PI/2.
    SUM = 0
    DO I=1,5
        SUM = SUM+FUNC(ZI(I))*VI(I)
    END DO
    PRINT *,'05 ABSCISSAS YIELDS',SUM,'ERROR',SUM-PI/2.
END PROGRAM EXERCISE4_4
...
SUBROUTINE FILL5(XI,WI)
!   FILLS THE TWO ARRAYS WITH VALUES FOR THE GAUSS-LEGENDRE
!   FOR N = 5
    REAL, DIMENSION(5)  :: XI,WI    !ABSCISSAS AND WEIGHTS
...
SUBROUTINE FILL16(XI,WI)
!   FILLS THE TWO ARRAYS WITH VALUES FOR THE GAUSS-LEGENDRE
!   FOR N = 16
    REAL, DIMENSION(16)  :: XI,WI    !ABSCISSAS AND WEIGHTS
    XI(1) = -0.0950125098376374
    XI(2) = 0.0950125098376374
    XI(3) = -0.2816035507792589
    XI(4) = 0.2816035507792589
    XI(5) = -0.4580167776572274
    XI(6) = 0.4580167776572274
    XI(7) = -0.6178762444026438
    XI(8) = 0.6178762444026438
    XI(9) = -0.7554044083550030
    XI(10) = 0.7554044083550030
    XI(11) = -0.8656312023878318
    XI(12) = 0.8656312023878318
    XI(13) = -0.9445750230732326
    XI(14) = 0.9445750230732326
    XI(15) = -0.9894009349916499
    XI(16) = 0.9894009349916499
    WI(1) = 0.1894506104550685
    WI(2) = 0.1894506104550685
    WI(3) = 0.1826034150449236
    WI(4) = 0.1826034150449236
    WI(5) = 0.1691565193950025
    WI(6) = 0.1691565193950025
    WI(7) = 0.1495959888165767
    WI(8) = 0.1495959888165767
    WI(9) = 0.1246289712555339
    WI(10) = 0.1246289712555339
    WI(11) = 0.0951585116824928
    WI(12) = 0.0951585116824928
    WI(13) = 0.0622535239386479
    WI(14) = 0.0622535239386479
    WI(15) = 0.0271524594117541
    WI(16) = 0.0271524594117541
    RETURN
END SUBROUTINE
