...
def forward2(x,h):
#Performs the forward 2-point method on the function defined by myFunction
#Input:  x -- independent variable
#        h -- step-size
#Output: ans -- dependent variable
...
def symmetric3(x,h):
#Performs the symmetric 3-point method on the function defined by myFunction
#Input:  x -- independent variable
#        h -- step-size
#Output: ans -- dependent variable
...
def symmetric4(x,h):
#Performs the symmetric 4-point method on the function defined by myFunction
#Input:  x -- independent variable
#        h -- step-size
#Output: ans -- dependent variable
    ans = (-2*myFunction(x-h)-3*myFunction(x)+6*myFunction(x+h)-myFunction(x+2*h))/(6*h)
    return(ans)

def symmetric5(x,h):
#Performs the symmetric 5-point method on the function defined by myFunction
#Input:  x -- independent variable
#        h -- step-size
#Output: ans -- dependent variable
